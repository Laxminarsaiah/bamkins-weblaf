...
public class BuildAntProjectPanel extends WebPanel {
	...
	String mavenBuildTitleTxt = "<html><font color=black>Select BUILD.XML Location:</font></html>";
	...
	class TextAreaThread extends Thread {
		...
		public void run() {
			...
			textArea.setText("");
			NotificationFactory.showNotification("Building Ant project...", "INFO");
			...
			try {
				...
				if (finishFlag == true) {
					...
					if (buildStatus) {
						...
						NotificationFactory.showNotification("Ant project build successfull", "INFO");
						...
						NotificationFactory.showNotification("Ant project build failed", "ERROR");
